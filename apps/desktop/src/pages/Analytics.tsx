            ...
            <>
              <div class="flex-1 min-w-40">
                ...
                <input
                  ...
                  class="w-full rounded-cards border border-fog-border bg-canvas px-4 py-2.5 text-sm text-void focus:border-fog-border focus:outline-none focus:ring-2 focus:ring-accent "
                />
              </div>
              <div class="flex-1 min-w-40">
