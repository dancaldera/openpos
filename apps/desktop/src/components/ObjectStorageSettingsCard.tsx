  ...
  return (
    <div>
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div class="md:col-span-2">
              <Input
                ...
                placeholder="https://t3.storageapi.dev"
                disabled={isSaving}
                required
      ...
      <DialogConfirm
        ...
        title={t('settings.objectStorageClear')}
        message={t('settings.objectStorageClearConfirm')}
        confirmText={t('settings.objectStorageClear')}
