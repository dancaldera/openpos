...
export function mapQueryRows<T>(columns: string[], rows: Array<Record<string, unknown> | unknown[]>): T[] {
...
export async function queryWithClient<T>(client: QueryableClient, sql: string, params: unknown[] = []): Promise<T[]> {
